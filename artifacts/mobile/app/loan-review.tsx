...
const GUARANTEES = [
  ...
  'Automatic repayment from forecast',
  'Instant funds transfer upon confirmation',
  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={{ paddingBottom: bottomPad + 24 }}>
      ...
      <View style={[styles.topBar, { paddingTop: topPad + 8 }]}>
        ...
        <Text style={styles.topBarTitle}>Loan Review</Text>
      ...
      <LinearGradient colors={['#0f172a', '#1e1b4b', '#312e81']} style={styles.darkSection}>
        <View style={styles.offerHeaderRow}>
          <Text style={styles.offerTitle}>Review Offer</Text>
        ...
        <View style={styles.amountCard}>
          ...
          <Text style={styles.amountSub}>Approved for expansion &amp; growth</Text>
        </View>

        <View style={styles.statGrid}>
          <StatCard icon="stats-chart-outline" label="INTEREST RATE" value="4.5%" sub="Fixed Annual" />
          <StatCard icon="calendar-outline" label="TERM PERIOD" value="12 Months" sub="Monthly Installments" />
          <StatCard icon="card-outline" label="MONTHLY" value="SAR 4,354" sub="Due on 5th" />
          <StatCard icon="shield-checkmark-outline" label="TOTAL COST" value="SAR 52,250" sub="Inc. 0% Processing" />
        </View>
        ...
        <View style={styles.guaranteeCard}>
          <View style={styles.guaranteeHeader}>
            ...
            <View style={{ marginLeft: 10 }}>
              <Text style={styles.guaranteeTitle}>Madarik Guarantee</Text>
              <Text style={styles.guaranteeSub}>Transparent terms, no hidden fees.</Text>
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  amountCard: {
    ...
    padding: 20, alignItems: 'center', marginTop: 18,
  },
